...
exports.createAirlines = async (res) => {
  try {
    await Airline.bulkCreate([
      { name: 'Aer Lingus	', address: '3447  Maple Lane', contact: 'tl0m6oab89s@temporary-mail.net', ranking: 1 },
      { name: 'Aeromexico', address: '3505  Hott Street', contact: 'qz57hueryc@temporary-mail.net', ranking: 3 },
      { name: 'Air France', address: '4502  Hinkle Deegan Lake Road', contact: 'evtp0p4ld5b@temporary-mail.net', ranking: 2 },
      { name: 'Air India', address: '3976  Oak Street', contact: '818m6qggl4y@temporary-mail.net', ranking: 3 },
      { name: 'Alitalia', address: '3954  Wakefield Street  ', contact: 'b1wu5fo8f2d@temporary-mail.net', ranking: 1 },
      { name: 'TAM', address: '370  Black Oak Hollow Road', contact: 'y058vl0but@temporary-mail.net', ranking: 1 },
      { name: 'Vietnam Airlines', address: '2118  Ashwood Drive', contact: 'ydhib63k0pg@temporary-mail.net', ranking: 2 },
    ])
